...
impl Neg for QQPoly {
    ...
    fn neg(mut self) -> QQPoly {
        // Negate the numerator polynomial
...
// Subtraction: QQPoly - QQPoly
impl Sub<QQPoly> for QQPoly {
    type Output = QQPoly;

    fn sub(self, rhs: QQPoly) -> QQPoly {
        ...
        // Subtract the scaled numerators
...
// SubAssign: QQPoly -= QQPoly
impl SubAssign<QQPoly> for QQPoly {
    fn sub_assign(&mut self, rhs: QQPoly) {
        *self = self.clone() - rhs;
    }
}
