...
mod tests {
    ...
    fn test_from_vec_i32() {
        ...
        assert_eq!(poly[0], Integer::from(1));
        assert_eq!(poly[1], Integer::from(2));
        assert_eq!(poly[2], Integer::from(3));
    }
    ...
    fn test_from_array_single_element() {
        ...
        assert_eq!(poly[0], Integer::from(42));
    }
    ...
    fn test_conversion_consistency() {
        ...
        let from_vec = ZZPoly::from(data.clone());
        let from_array = ZZPoly::from([1, 2, 3]);
        let from_array_ref = ZZPoly::from(&[1, 2, 3]);
